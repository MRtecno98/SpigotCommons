...
import com.spigot.libraries.exceptions.AmbiguityException;
...
public class CXMLWalker {
	...
	public CXMLNode walk(CXMLNode parent, Node node) {
		...
		if(filteredImports.size() > 1) throw new AmbiguityException("Ambiguos node class name based on imported classes");
